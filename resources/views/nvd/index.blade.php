        ...
        <div class="container mx-auto p-4">
            ...
            @isset($vulnerabilities)
                @if(count($vulnerabilities) > 0)
                    ...
                    <h2 class="text-2xl font-bold mb-4 text-green-600">Recently Modified This Month</h2>
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-8">
                        @foreach($vulnerabilities as $vuln)
                            @if(strpos($vuln['LastModified'], now()->format('Y-m')) === 0)
                                <div class="card bg-white p-6 rounded-lg shadow-lg hover:shadow-xl">
                                    ...
                                    <p class="text-sm text-gray-500">Last Modified: <span class="font-semibold">{{ $vuln['LastModified'] }}</span></p>
